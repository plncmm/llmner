SYSTEM_TEMPLATE_EN_INLINE = """You are a named entity recognizer that must detect the next entities: 
{entities} 
...
SYSTEM_TEMPLATE_EN_INLINE_MULTI_TURN = """You are a named entity recognizer that must detect the next entities:
{entities}
...
SYSTEM_TEMPLATE_EN_INLINE_MULTI_TURN_SPECIAL_TOKENS = """You are a named entity recognizer that must detect the next entities:
{entities}
...
SYSTEM_TEMPLATE_EN_JSON_MULTI_TURN = """You are a named entity recognizer that must detect the next entities:
{entities}
...
SYSTEM_TEMPLATE_EN_JSON = """You are a named entity recognizer that must detect the next entities:
{entities}
...
HUMAN_TEMPLATE_MULTI_TURN = """In the next text, annotate the entity """